...
class AppNavigationScreen extends StatelessWidget {
                      ...
                      child: Container(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapHomescreenforproduct(context);
                                    },
                                    child: Container(
                                        width: getHorizontalSize(375.00),
                                        decoration: AppDecoration.fillWhiteA700,
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapSuccessfulpayment(context);
                                    },
                                    child: Container(
                                        width: getHorizontalSize(375.00),
                                        decoration: AppDecoration.fillWhiteA700,
  ...
  onTapFlashscreen(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.flashScreen);
  }
  ...
  onTapHomescreenforproduct(BuildContext context) {
  ...
  onTapOffers(BuildContext context) {
  ...
  onTapElectronics(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.electronicsScreen);
  }
  ...
  onTapChooseaddress(BuildContext context) {
  ...
  onTapSelectcard(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.selectCardScreen);
  }

  onTapSuccessfulpayment(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.successfulPaymentScreen);
  }

  onTapCustomerprofile(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.customerProfileScreen);
  }

  onTapServices2demo(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.services2DemoScreen);
  }
}
