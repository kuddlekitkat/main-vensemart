...
class AvailableServicesListScreen extends StatefulWidget {
  ...
  AvailableServicesListScreen(
      {required this.lat, required this.long, required this.id});

  @override
  State<AvailableServicesListScreen> createState() =>
      _AvailableServicesListScreenState();
}

class _AvailableServicesListScreenState
    extends State<AvailableServicesListScreen> {
