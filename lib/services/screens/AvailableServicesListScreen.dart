...
class AvailableServicesListScreen extends StatefulWidget {
  ...
  String id;
   ...
   AvailableServicesListScreen({required this.lat, required this.long, required this.id});
...
class _AvailableServicesListScreenState extends State<AvailableServicesListScreen> {
  ...
  contentContainer({String? homeId,String? name, String? image,String? location,String? categoryname,String? price}) => Container(
    color: Colors.white,
    child: Row(
                    ...
                    children:  [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text('hello',style: TextStyle(fontSize: 12,color: Colors.grey[700]),),
                        ],
                      ),
                      SizedBox(height: 20,),
                      Row(
                  ...
                  Padding(
                    ...
                    child: TextButton(onPressed: (){
                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(height: 40,),
                          // Text(categoryname.toString(),style: TextStyle(fontSize: 15,color: Colors.grey[700]),),
                          Text("N${price}",style: TextStyle(fontSize: 15,color: Colors.black,fontWeight: FontWeight.bold),),
                          SizedBox(height: 40,),
