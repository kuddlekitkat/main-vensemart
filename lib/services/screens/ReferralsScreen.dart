                ...
                child: Column(
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () {
                        String textToShare =
                            'pls download the vensemart app and register to get rewards, here is the link to app, https://api.vensemart.com/api/ref?=${providerServices?.referralsModel?.data?.referral_code}, when registering, kindly enter my referral code ${providerServices?.referralsModel?.data?.referral_code}';
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            String textToShare =
                                'pls download the vensemart app and register to get rewards, here is the link to app, ${providerServices?.referralsModel?.data?.referral_code}, when registering, kindly enter my referral code ${providerServices?.referralsModel?.data?.referral_code}';
                            shareText(textToShare);
                          },
                          icon: Icon(Icons.share),
                          tooltip: 'Share',
