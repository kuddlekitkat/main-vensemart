...
class ServiceDeliveryDetailScreen extends StatefulWidget {
  ...
  @override
  State<ServiceDeliveryDetailScreen> createState() =>
      _ServiceDeliveryDetailScreenState();
}

class _ServiceDeliveryDetailScreenState
    extends State<ServiceDeliveryDetailScreen> {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                    'Service to be rendered by: ${providerServices?.serviceIdModel?.data?.name}'),
                              ],
                            ),
                          )),
                      Padding(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AddAddressScreen(
          ...
          service_date: widget.service_date,
        ),
      ),
    );
  }
