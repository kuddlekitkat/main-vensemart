                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child:
                          AutoSizeText('${widget.trendingserviceModel?.name}',
                              style: TextStyle(
                                fontSize: 1.5 *
                    ...
                    Container(
                      width: MediaQuery.of(context).size.width / 2.5,
                      child: Text(
                          "${widget.trendingserviceModel?.categoryName ?? 'Inverter installer'}",
                          style: AppStyle.txtIBMPlexSansMedium14Gray2000),
                    ),
                    SizedBox(
                      height: 2,
                    ),
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          '${widget.trendingserviceModel?.location != null ? widget.trendingserviceModel?.location.length > 13 ? '${widget.trendingserviceModel?.location.substring(0, 11)}...' : widget.trendingserviceModel?.location : widget.trendingserviceModel?.location}',
                          style: AppStyle.txtIBMPlexSansMedium14Gray2000,
                        ),
                      ],
                    ),
                  ...
                  children: [
                    Padding(
                      ...
                      child: TextButton(
                        onPressed: () {},
                        child: Text(
                          "${widget.trendingserviceModel?.serviceTypePrice}",
                          style: TextStyle(
                              fontSize: 1.5 *
                                  MediaQuery.of(context).size.height *
                                  0.01,
                                                ...
                                                builder: (_, provider, __) =>
                                                    ServiceDeliveryDetailScreen(
                                                        ...
                                                        service_date:
                                                            timeinput.text,
                                                        service_id:
                                                            '${widget.trendingserviceModel?.id}'),
                                              ),
                                            ),
                                          );
                                        },
