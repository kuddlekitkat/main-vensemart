          ...
          Container(
            ...
            child: CachedNetworkImage(
              imageUrl: '${widget.trendingserviceModel?.profile}' ??
                  'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAkGBwgHBgkIBwgKCgkLDRYPDQwMDRsUFRAWIB0iIiAdHx8kKDQsJCYxJx8fLT0tMTU3Ojo6Iys/RD84QzQ5OjcBCgoKDQwNGg8PGjclHyU3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nz'
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text('${widget.trendingserviceModel?.name ?? 'Jake'}',
                        style: TextStyle(
                          fontSize: 10,
                          color: Colors.black,
                    ...
                    Text(
                      "${widget.trendingserviceModel?.categoryName ?? 'Barbing'}",
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                            '${widget.trendingserviceModel?.state ?? 'Abuja'}'),
