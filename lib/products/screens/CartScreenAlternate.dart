...
class CartScreenAlternate extends StatefulWidget {
  const CartScreenAlternate({Key? key}) : super(key: key);

  @override
  State<CartScreenAlternate> createState() => _CartScreenAlternateState();
}

class _CartScreenAlternateState extends State<CartScreenAlternate> {
