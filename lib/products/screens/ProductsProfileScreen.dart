...
class ProductsProfileScreen extends StatefulWidget {
  const ProductsProfileScreen({Key? key}) : super(key: key);

  @override
  State<ProductsProfileScreen> createState() => _ProductsProfileScreenState();
}
...
class _ProductsProfileScreenState extends State<ProductsProfileScreen> {
