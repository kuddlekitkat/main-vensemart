          ...
          children: [
            ...
            Container(
               width: 320,
                child: Column(
                  children: [
                    Text('Your Order has been placed',style: TextStyle(fontSize: 20.0),),
                    Text('Successfully',style: TextStyle(fontSize: 20.0),),
                  ],
                )),
            ...
            Container(
                width: 320,child: Column(
                  children: [
                    Text('The order details  have been sent to',style: TextStyle(
